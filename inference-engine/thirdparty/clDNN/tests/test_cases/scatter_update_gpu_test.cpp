...
TEST(scatter_update_gpu_fp16, d8111_axisB) {
    //  Dictionary : 8x1x1x1
    //  Indexes : 4x1x1x1
    //  Updates : 4x1x1x1
    //  Axis : 0
    ...
    topology.add(input_layout("InputUpdates", input3.get_layout()));
    topology.add(
        scatter_update("scatter_update", "InputDictionary", "InputText", "InputUpdates", axis, tensor(8, 1, 1, 1))
    );
...
TEST(scatter_update_gpu_fp16, d4311_axisB) {
    ...
    topology.add(input_layout("InputUpdates", input3.get_layout()));
    topology.add(
        scatter_update("scatter_update", "InputDictionary", "InputText", "InputUpdates", axis, tensor(4, 3, 1, 1))
    );
...
TEST(scatter_update_gpu_fp16, d2521_axisF) {
    ...
    topology.add(input_layout("InputUpdates", input3.get_layout()));
    topology.add(
        scatter_update("scatter_update", "InputDictionary", "InputText", "InputUpdates", axis, tensor(2, 5, 1, 2))
    );
...
TEST(scatter_update_gpu_fp16, d2241_axisY) {
    ...
    topology.add(input_layout("InputUpdates", input3.get_layout()));
    topology.add(
        scatter_update("scatter_update", "InputDictionary", "InputText", "InputUpdates", axis, tensor(2, 2, 1, 4))
    );
...
TEST(scatter_update_gpu_fp32, d2411_axisf) {
    //  Dictionary : 2x4x1x1
    //  Indexes : 1x1x2x1
    //  Updates : 2x1x1x2
    //  Axis : 1
    ...
    auto input3 = memory::allocate(engine, { data_types::f32, format::bfyx, { 2, 1, 2, 1 } });// Updates
    auto axis = cldnn::scatter_update::scatter_update_axis::along_f;
...
TEST(scatter_update_gpu_fp16, d8x2x20x1_axisB) {
    ...
    topology.add(input_layout("InputUpdates", input3.get_layout()));
    topology.add(
        scatter_update("scatter_update", "InputDictionary", "InputText", "InputUpdates", axis, tensor(8, 2, 1, 20))
    );
...
TEST(scatter_update_gpu_fp32, d2214_axisX) {
    ...
    topology.add(input_layout("InputUpdates", input3.get_layout()));
    topology.add(
        scatter_update("scatter_update", "InputDictionary", "InputText", "InputUpdates", axis, tensor(2, 2, 4, 1))
    );
...
TEST(scatter_update_gpu_int32, d6211_axisB) {
    ...
    topology.add(input_layout("InputUpdates", input3.get_layout()));
    topology.add(
        scatter_update("scatter_update", "InputDictionary", "InputText", "InputUpdates", axis, tensor(6, 2, 1, 1))
    );
...
TEST(scatter_update_gpu_int32, d3151_axisY) {
    ...
    topology.add(input_layout("InputUpdates", input3.get_layout()));
    topology.add(
        scatter_update("scatter_update", "InputDictionary", "InputText", "InputUpdates", axis, tensor(3, 1, 1, 5))
    );
...
TEST(scatter_update_gpu_fp16, d4311_undefined_behavior_axisB) {
    ...
    auto input3 = memory::allocate(engine, { data_types::f16, format::bfyx, { 3, 2, 1, 3 } });// Updates
    auto axis = cldnn::scatter_update::scatter_update_axis::along_b;
    ...
    set_values(input3, {
        ...
        FLOAT16(6.0f), FLOAT16(6.0f), FLOAT16(6.0f),
        FLOAT16(9.0f), FLOAT16(9.0f), FLOAT16(9.0f),

        FLOAT16(5.0f), FLOAT16(5.0f), FLOAT16(5.0f),
        FLOAT16(10.0f), FLOAT16(11.0f), FLOAT16(12.0f)
    });
